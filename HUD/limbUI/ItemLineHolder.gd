	...
	for itemlines in get_children():
		for child in itemlines.get_children():
			if child is ItemSlot:
				...
				child.update(child.item_in_slot_resource)
...
func _update_item_description_panel(item_slot: ItemSlot) -> void:
	...
	if item_slot.item_in_slot_resource is Weapon:
		...
		description_panel_dice.generate_dice(item_slot.item_in_slot_resource.weapon_hit_die)
		...
		description_panel_dice.generate_dice(item_slot.item_in_slot_resource.block_hit_die)
